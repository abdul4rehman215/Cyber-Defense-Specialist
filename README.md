...
>
> Simulates real-world Security Operations Center (SOC) workflows — from log analysis and network monitoring to SIEM engineering, SOAR orchestration, and full incident lifecycle execution.
